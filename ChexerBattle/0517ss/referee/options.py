...
player package/class specifications (positional arguments):
  ...
  your top-level package (i.e. 'Our_teamNAME').
  ...
  with import statements, e.g. 'Our_teamNAME.player2') or relative path (to a
  file or directory containing the Python module, e.g. 'Our_teamNAME/player3'
  or 'Our_teamNAME/players/player4.py').
  ...
  (e.g. 'Our_teamNAME:DifferentPlayer').
