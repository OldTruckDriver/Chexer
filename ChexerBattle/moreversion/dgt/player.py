...
class ExamplePlayer:
    ...
    def evaluation(self, node, root_colour, current_player):
        v = node.state.board.evaluation(current_player, self.score)
    ...
    def additional_evaluation(self, node, value):
        ...
        w_kill = 1
        w_danger = 100
        if len(current_board.players_hexes[colour_compare]) > 4:
            w_safety = 1
        else:
            w_safety = 10
