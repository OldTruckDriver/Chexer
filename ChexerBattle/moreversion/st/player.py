...
class Board:
    ...
    def evaluation(self, root_colour, all_nodes, current_player, score):
        ...
        w_h2 = 1
        w_h3 = 1
        if score[colour_1] + len(self.players_hexes[colour_1]) >= 4:
            w_h1 = 1000
        elif score[colour_2] + len(self.players_hexes[colour_2]) >= 4:
            w_h2 = 1000
        elif score[colour_3] + len(self.players_hexes[colour_3]) >= 4:
            w_h3 = 1000
        if current_player == 1:
