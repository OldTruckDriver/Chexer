...
class ExamplePlayer:
    ...
    def MAXN(self, node, depth, current_player, root_colour):
        ...
        for c_node in node.children():
            ...
            if result[current_player - 1] > best[current_player - 1]:
                ...
                # result_board = result_node.state.board
                # best_board = best_node.state.board
                # colour_compare = best_board.colour
                # result_num_danger = -1 * result_board.danger(colour_compare, node.all_nodes)
                # best_num_danger = -1 * best_board.danger(colour_compare, node.all_nodes)
                case1 = 'killed'
                case2 = 'danger'
                case3 = 'safety'
    ...
    def additional_evaluation(self, node, case):
        ...
        if case == 'danger':
            ...
            num = node.killed[current_player]
        return num
